...
from ..database import get_session, Project, ProjectStatus, Export
...
class HealthCalculator:
    ...
    def calculate_health_score(project_id: int) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                ...
                'days_since_modification': days_since_modification if project.modified_date else None,
    ...
    @staticmethod
    def get_projects_by_health(level: Optional[str] = None) -> List[int]:
