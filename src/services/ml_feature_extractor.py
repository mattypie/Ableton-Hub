...
from .asd_parser import ASDParser, find_asd_files
...
class MLFeatureExtractor:
    ...
    def extract_project_features(
        self, als_path: Path, project_id: int | None = None, audio_paths: list[Path] | None = None
    ) -> ProjectFeatureVector | None:
    ...
    def _extract_audio_features(self, audio_path: Path) -> AudioFeatures | None:
    ...
    def extract_batch_features(
        self, projects: list[tuple[Path, int | None, list[Path] | None]]
