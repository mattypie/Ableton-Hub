...
from PyQt6.QtWidgets import (
    ...
    QDialogButtonBox, QMessageBox, QColorDialog, QDateEdit, QCheckBox
)
from PyQt6.QtCore import Qt, QDate
from PyQt6.QtGui import QColor, QPixmap

from ...database import get_session, Collection, CollectionType
...
class CreateCollectionDialog(QDialog):
    ...
    def __init__(self, parent=None, collection_id: Optional[int] = None):
        super().__init__(parent)
        
        self.collection_id = collection_id
        self._color = AbletonTheme.COLORS['accent']
        self._artwork_path: Optional[str] = None
    ...
    def _load_collection(self) -> None:
        ...
        try:
            ...
            if collection:
                ...
                # Type
                type_idx = [ct.value for ct in CollectionType].index(collection.collection_type.value)
