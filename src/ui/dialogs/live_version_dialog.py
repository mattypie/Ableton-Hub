...
class LiveVersionDialog(QDialog):
    ...
    def __init__(self, project_name: str, parent=None):
        ...
        self.selected_version: Optional[LiveVersion] = None
    ...
    def _setup_ui(self) -> None:
        ...
        title.setStyleSheet(f"font-size: 16px; font-weight: bold; color: {AbletonTheme.COLORS['text_primary']};")
    ...
    def get_selected_version(self) -> Optional[LiveVersion]:
