...
from PyQt6.QtWidgets import (
    ...
    QSpinBox, QDateEdit, QDialogButtonBox, QMessageBox, QGroupBox
)
        ...
        try:
            ...
            if self.collection_id:
                ...
                if collection:
                    ...
                    collection.collection_type = CollectionType(self.type_combo.currentText().lower())
